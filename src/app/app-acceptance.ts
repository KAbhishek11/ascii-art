...
import {
  starterControlSectionInventory as appControlSectionInventory,
} from "./app-schema";
...
export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  ...
  {
    automated: true,
    automatedTestName: "acceptance: layers panel selects objects",
    browser: true,
    browserTestName: "browser: layers panel selects objects",
    componentType: "layers",
    evidence: "command-side-effect",
    expectedObservable:
      "Clicking a layer row in the Layers panel selects that object and updates state.selectedLayerId so the Object controls and canvas selection reflect it.",
    fixture: "two uploaded image objects",
    id: "layers.selection",
    kind: "runtime",
    layerCoverage: "selection",
    target: "panels.layers",
    userAction:
      "Upload two objects, click each layer row in the real Layers panel, and verify selection changes to that object.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: layers panel toggles object visibility",
    browser: true,
    browserTestName: "browser: layers panel toggles object visibility",
    componentType: "layers",
    evidence: "product-output",
    expectedObservable:
      "Toggling a layer's visibility eye in the Layers panel hides or shows that object's ASCII in the composited canvas output.",
    fixture: "two uploaded image objects",
    ...
    target: "panels.layers",
    userAction:
      "Upload two objects and click a layer's visibility toggle in the real Layers panel; verify that object's ASCII disappears from the canvas.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: layers panel reorders objects",
    browser: true,
    browserTestName: "browser: layers panel reorders objects",
    componentType: "layers",
    evidence: "product-output",
    expectedObservable:
      "Dragging a layer row in the Layers panel changes object z-order so the composited canvas draws objects in the new order.",
    fixture: "two overlapping image objects",
    id: "layers.reorder",
    kind: "runtime",
    layerCoverage: "reorder",
    target: "panels.layers",
    userAction:
      "Upload two overlapping objects, drag a layer row to reorder in the real Layers panel, and verify the front/back stacking changes on the canvas.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: layers panel groups objects",
    browser: true,
    browserTestName: "browser: layers panel groups objects",
    componentType: "layers",
    evidence: "command-side-effect",
    expectedObservable:
      "Adding a group and moving objects into it in the Layers panel nests those objects under the group and moves them together.",
    fixture: "two uploaded image objects",
    id: "layers.grouping",
    kind: "runtime",
    ...
    target: "panels.layers",
    userAction:
      "Upload two objects, add a group in the real Layers panel, and drag objects into the group to verify nesting.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: canvas move handle repositions selected object",
    browser: true,
    browserTestName: "browser: canvas move handle repositions selected object",
    canvasHandle: {
      exportCleanTestName: "browser: export excludes canvas handles",
      outputObservable: "The selected object's ASCII moves to the dragged position in the composited canvas output.",
      testId: "canvas-object-move",
      writesTarget: "controls.setValue",
    },
    componentType: "canvasHandle",
    evidence: "product-output",
    expectedObservable:
      "Dragging the canvas move handle repositions the selected object by writing its obj.<layerId>.x/y through controls.setValue, moving only that object.",
    fixture: "two uploaded image objects",
    id: "canvas.moveHandle",
    kind: "canvas-handle",
    target: "controls.setValue",
    userAction:
      "Select an object, drag the move handle on the canvas, and verify only that object's position changes.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: canvas resize handle resizes selected object",
    browser: true,
    browserTestName: "browser: canvas resize handle resizes selected object",
    canvasHandle: {
      exportCleanTestName: "browser: export excludes canvas handles",
      outputObservable: "The selected object's ASCII resizes to the dragged bounds in the composited canvas output.",
      testId: "canvas-object-resize-se",
      writesTarget: "controls.setValue",
    },
    componentType: "canvasHandle",
    evidence: "product-output",
    expectedObservable:
      "Dragging a canvas corner resize handle changes the selected object's obj.<layerId>.w/h through controls.setValue, resizing only that object.",
    fixture: "two uploaded image objects",
    id: "canvas.resizeHandle",
    kind: "canvas-handle",
    target: "controls.setValue",
    userAction:
      "Select an object, drag the south-east resize handle on the canvas, and verify only that object's size changes.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: glyph selector changes ASCII characters",
    browser: true,
    browserTestName: "browser: glyph selector changes ASCII characters",
    componentType: "select",
    evidence: "product-output",
    expectedObservable:
      "Choosing Classic, Blocks, and Fine changes the glyph mapping of the currently selected object in the composited ASCII canvas output.",
    fixture: "two uploaded objects with one selected",
    id: "selectedLayer.charset",
    kind: "control",
    layerCoverage: "selected-layer-controls",
    optionCoverage: ["classic", "blocks", "fine"],
    target: "selectedLayer.charset",
    userAction:
      "Select an object and choose each visible Glyphs option; verify only the selected object's glyphs change.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: cell size slider changes ASCII density live",
    browser: true,
    browserTestName: "browser: cell size slider changes ASCII density live",
  ...
  {
    automated: true,
    automatedTestName: "acceptance: contrast slider changes ASCII tone mapping live",
    browser: true,
    browserTestName: "browser: contrast slider changes ASCII tone mapping live",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "Dragging Contrast remaps the selected object's tones to different glyph weights, leaving other objects unchanged.",
    fixture: "two uploaded objects with one selected",
    ...
    userAction:
      "Select an object, drag the real Contrast slider thumb, and verify only the selected object's tone mapping changes.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: brightness slider changes ASCII tone mapping live",
    browser: true,
    browserTestName: "browser: brightness slider changes ASCII tone mapping live",
    componentType: "slider",
    evidence: "product-output",
    expectedObservable:
      "Dragging Brightness shifts the selected object's sampled tone before glyph selection, leaving other objects unchanged.",
    fixture: "two uploaded objects with one selected",
    id: "selectedLayer.brightness",
    kind: "control",
    layerCoverage: "selected-layer-controls",
    target: "selectedLayer.brightness",
    userAction:
      "Select an object, drag the real Brightness slider thumb, and verify only the selected object's tone changes.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: invert switch reverses ASCII tone mapping",
    browser: true,
    browserTestName: "browser: invert switch reverses ASCII tone mapping",
    componentType: "switch",
    evidence: "product-output",
    expectedObservable:
      "Turning Invert on reverses the selected object's dark and light glyph choices, leaving other objects unchanged.",
    fixture: "two uploaded objects with one selected",
    id: "selectedLayer.invert",
    kind: "control",
    layerCoverage: "selected-layer-controls",
    target: "selectedLayer.invert",
    userAction: "Select an object and click the Invert switch; verify only that object inverts.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: color mode select switches mono and source color",
    browser: true,
    browserTestName: "browser: color mode select switches mono and source color",
    componentType: "select",
    evidence: "product-output",
    expectedObservable:
      "Choosing Mono uses the selected object's Ink color while Source samples that object's source color, leaving other objects unchanged.",
    fixture: "two uploaded objects with one selected",
    id: "selectedLayer.colorMode",
    kind: "control",
    layerCoverage: "selected-layer-controls",
    optionCoverage: ["mono", "source"],
    target: "selectedLayer.colorMode",
    userAction:
      "Select a colored object, choose Source and Mono, and verify only the selected object's coloring changes.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: ink color changes mono ASCII glyph color",
    browser: true,
    browserTestName: "browser: ink color changes mono ASCII glyph color",
    componentType: "color",
    evidence: "product-output",
    expectedObservable:
      "The Ink control is visible only while Color is Mono and becomes hidden/unavailable when selectedLayer.colorMode is set to Source; while visible, changing Ink changes the selected object's glyph color, leaving other objects unchanged.",
    fixture: "two uploaded objects with one selected in Mono color mode",
    id: "selectedLayer.ink",
    kind: "control",
    layerCoverage: "selected-layer-controls",
    target: "selectedLayer.ink",
    userAction:
      "Select an object, keep Color set to Mono and change the Ink color picker, then switch Color to Source and verify the Ink control becomes hidden/unavailable.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: background include and color control preview and PNG alpha",
    browser: true,
    browserTestName: "browser: background include and color control preview and PNG alpha",
    componentType: "switch",
  ...
  },
  {
    ...
    evidence: "rendered-pixels",
    expectedObservable:
      "Changing Background color affects preview and exported PNG pixels when Include is on.",
    fixture: "uploaded contrast image with visible background cells",
    id: "appearance.background",
    kind: "control",
    target: "appearance.background",
    userAction:
      "Change the Background color and export PNG to verify the current background color reaches preview and image bytes.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: image export format and resolution change output bytes",
    browser: true,
    browserTestName: "browser: image export format and resolution change output bytes",
    componentType: "select",
    evidence: "exported-bytes",
    expectedObservable:
      "Choosing PNG versus JPG changes encoded file type, and choosing 2K versus 4K changes decoded image dimensions through createToolcraftPngExportCanvas resolution.",
    fixture: "uploaded contrast image exported at 2K and 4K",
    id: "export.image",
    kind: "control",
    optionCoverage: ["png", "jpg", "2k", "4k"],
    target: "export.image.format",
    userAction:
      "Choose PNG and JPG formats, choose 2K and 4K resolutions, click Export PNG, wait for the returned Promise progress indicator, and decode exported image bytes to prove file type and actual dimensions changed.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: image export format and resolution change output bytes",
    ...
    evidence: "exported-bytes",
    expectedObservable:
      "Choosing 2K versus 4K changes decoded image dimensions through createToolcraftPngExportCanvas resolution.",
    fixture: "uploaded contrast image exported at 2K and 4K",
    ...
    userAction:
      "Choose 2K and 4K resolutions, click Export PNG, wait for the returned Promise progress indicator, and decode exported image bytes to prove actual dimensions changed.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: image export format and resolution change output bytes",
  ...
  {
    automated: true,
    automatedTestName: "acceptance: localStorage persistence restores ASCII settings",
    browser: true,
    browserTestName: "browser: localStorage persistence restores ASCII settings",
    componentType: "persistence",
    evidence: "persistence-state",
    expectedObservable:
      "Edited ASCII settings restore after a real browser reload through schema localStorage persistence.",
    fixture: "changed Cell size and Invert settings",
    id: "persistence.values",
    kind: "runtime",
    persistenceCoverage: "reload",
    target: "persistence.localStorage",
    userAction:
      "Change Cell size and Invert, wait for persistence, reload the page, and verify the controls and product output restore.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: editable output sizing keeps upload cropped to canvas",
    browser: true,
    browserTestName: "browser: editable output sizing keeps upload cropped to canvas",
    componentType: "canvas",
    evidence: "rendered-pixels",
    expectedObservable:
      "Uploading a differently shaped image keeps the current editable canvas size and renders the source as cover/crop inside those bounds.",
    fixture: "portrait image uploaded into default 2560x1440 canvas",
    id: "canvas.editableOutput",
    kind: "runtime",
    target: "canvas.size",
    userAction:
      "Record the current canvas size, upload a portrait image, and verify Canvas width and Canvas height remain unchanged while the ASCII output covers/crops the canvas.",
  },
  {
    automated: true,
    automatedTestName: "acceptance: editable output sizing keeps upload cropped to canvas",
    ...
    evidence: "rendered-pixels",
    expectedObservable:
      "Runtime Resolution scale is visible in Setup for the Canvas 2D/WebGL ASCII preview and increases backing pixels without changing CSS output size.",
    fixture: "default canvas with uploaded image",
    id: "canvas.renderScale",
    kind: "control",
    target: "canvas.renderScale",
    userAction:
      "Verify the runtime Resolution scale control exists and that the ASCII product canvas keeps the selected backing-pixel scale while the visible canvas remains 2560x1440.",
  },
];
...
export function validateToolcraftAcceptanceCoverage(
  ...
  const errors: string[] = [];
  if (schema !== appSchema) {
    const appAcceptanceEntries = new Set(appAcceptance);
    acceptance = acceptance.filter((entry) => !appAcceptanceEntries.has(entry));
  }
